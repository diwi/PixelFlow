...
public class Skylight_BulletPhysics_Breakable_VideoExport extends PApplet {
  ...
  public class MyVideoExport extends VideoExport{

    public MyVideoExport(PApplet parent, String outputFileName) {
      super(parent, outputFileName);
    }
...
//  });
    ...
    video_export = new MyVideoExport(this, "examples/videos/nogit/diewald_"+this.getClass().getSimpleName()+".mp4");
    video_export.setDebugging(true);
//    video_export.setQuality(70, 256);
...
//    video_export.saveFrame();
  ...
  DwGLTexture gltex = new DwGLTexture();
  Copy copy;
  byte[] bytebuffer;
...
//      }
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { Skylight_BulletPhysics_Breakable_VideoExport.class.getName() });
  }
}
