...
package Skylight.Skylight_BulletPhysics_CellFracture;
...
public class Skylight_BulletPhysics_CellFracture extends PApplet {
  
  //
  // author: Thomas Diewald
  //
  // video: https://vimeo.com/218351376
  //
  //
...
//    pg_aa.save(file.getAbsolutePath());
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { Skylight_BulletPhysics_CellFracture.class.getName() });
  }
}
