...
public class FlowFieldParticles_DamBreak2 extends PApplet {
...
//    particles.param.col_B = new float[]{0.20f, 0.05f, 0.10f, 0};
    particles.param.col_A = new float[]{1.00f, 0.50f, 0.20f, 2};
    particles.param.col_B = new float[]{0.00f, 0.55f, 1.00f, 0};
    ...
    particles.param.size_display   = 4;
    ...
    particles.param.wh_scale_col = -1; // -1 doubling the size of the collision buffer
...
//    particles.spawn(vw, vh, sr);
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { FlowFieldParticles_DamBreak2.class.getName() });
  }
