...
package Miscellaneous.Geometry_Grid;

import com.thomasdiewald.pixelflow.java.geometry.DwHalfEdge;
import com.thomasdiewald.pixelflow.java.geometry.DwIFSGrid;
...
public class Geometry_Grid extends PApplet {
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { Geometry_Grid.class.getName() });
  }
}