...
public class SoftBody2D_Chain extends PApplet {
  ...
  DwParticle2D.Param param_chain = new DwParticle2D.Param();
...
//    context.printGL();
  ...
  public void createParticle(float spawn_x, float spawn_y){
    ...
    if(idx_prev >= 0){
      ...
      pa.px = pb.cx;
      pa.py = pb.cy;
      DwSpringConstraint2D.addSpring(pb, pa, rest_len*rest_len, param_spring_chain);
      NUM_SPRINGS++;
    }
  }
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { SoftBody2D_Chain.class.getName() });
  }
}