...
package Skylight_ClothSimulation_FXAA;
...
public class Skylight_ClothSimulation_FXAA extends PApplet {
  ...
  public void draw() {
    ...
    // Apply AntiAliasing
    fxaa.apply(skylight.renderer.pg_render, pg_aa);
...
//      }
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { Skylight_ClothSimulation_FXAA.class.getName() });
  }
}