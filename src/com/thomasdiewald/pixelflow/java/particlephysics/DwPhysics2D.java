...
public class DwPhysics2D {
  ...
  private DwParticle2D[] particles;
  ...
  public DwParticle2D[] getParticles(){
    return particles;
  }
  ...
  public void addParticles(DwParticle2D[] particles_add, int particles_add_count){
  ...
  public void setParticles(DwParticle2D[] particles_set, int particles_set_count){
  ...
  private void update(DwParticle2D[] particles, int particles_count, float timestep){
