...
public class VerletPhysics3D {
  ...
  public VerletParticle3D[] getParticles(){
    return particles;
  }
  ...
  public void addParticles(VerletParticle3D[] particles_add, int particles_add_count){
  ...
  public void setParticles(VerletParticle3D[] particles_set, int particles_set_count){
  ...
  public void reset(){
    ...
    particles_count = 0;
    particles = new VerletParticle3D[particles_count];
  }
  ...
  private void update(VerletParticle3D[] particles, int particles_count, float timestep){
