...
public class DoG {
  ...
  public void apply(PGraphics2D srcA, PGraphics2D srcB, PGraphics2D dst, float[] multiplier) {
    ...
    dst.beginDraw();
    context.begin();
    if(shader_DoG_UBYTE == null) shader_DoG_UBYTE = context.createShader(PixelFlow.SHADER_DIR+"Filter/DoG_UBYTE.frag");
  ...
  public void apply(DwGLTexture srcA, DwGLTexture srcB, DwGLTexture dst, float[] multiplier) {
    ...
    if(shader_DoG == null) shader_DoG = context.createShader(PixelFlow.SHADER_DIR+"Filter/DoG.frag");
