...
package com.thomasdiewald.pixelflow.java.filter;
...
public class Laplace {
  ...
  public Laplace(PixelFlow context){
  ...
  public void apply(PGraphics2D src, PGraphics2D dst, TYPE type) {
    ...
    dst.beginDraw();
    context.begin();
    if(shader_ubyte[type.ordinal()] == null) shader_ubyte[type.ordinal()] = context.createShader(PixelFlow.SHADER_DIR+"Filter/"+type.shader_ubyte);
  ...
  public void apply(DwGLTexture src, DwGLTexture dst, TYPE type) {
    ...
    if(shader[type.ordinal()] == null) shader[type.ordinal()] = context.createShader(PixelFlow.SHADER_DIR+"Filter/"+type.shader);
