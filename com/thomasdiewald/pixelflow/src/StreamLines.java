...
public class StreamLines{
  ...
  public StreamLines(PixelFlow context){
...
//  }
  ...
  public void resize(int num_lines_x_, int num_lines_y_){
    ...
    // create shader
    shader_streamlineInit   = context.createShader(PixelFlow.SHADER_DIR+"Streamlines/streamlineInit.frag");
    shader_streamlineUpdate = context.createShader(PixelFlow.SHADER_DIR+"Streamlines/streamlineUpdate.frag");
    shader_streamlineRender = context.createShader(PixelFlow.SHADER_DIR+"Streamlines/streamlineRender.vert", PixelFlow.SHADER_DIR+"Streamlines/streamlineRender.frag");
  ...
  public void render(PGraphics2D dst, Fluid fluid, int spacing){
