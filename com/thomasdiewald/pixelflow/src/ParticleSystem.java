...
public class ParticleSystem{
  ...
  public ParticleSystem(PixelFlow context, int num_particels_x, int num_particels_y){
  ...
  public void resize(PixelFlow context_, int num_particels_x, int num_particels_y){
    context = context_;
...
//    System.out.println("ParticelSystem: size = "+particles_x+"/"+particles_y +" ("+particles_x*particles_y+" objects)");
    ...
    // create shader
    shader_particleInit   = context.createShader(PixelFlow.SHADER_DIR+"ParticleSystem/particleInit.frag");
    shader_particleUpdate = context.createShader(PixelFlow.SHADER_DIR+"ParticleSystem/particleUpdate.frag");
    shader_particleRender = context.createShader(PixelFlow.SHADER_DIR+"ParticleSystem/particleRender.vert", PixelFlow.SHADER_DIR+"ParticleSystem/particleRender.frag");
